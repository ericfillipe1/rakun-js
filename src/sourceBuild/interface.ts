...
export type ReturnUnzip<T> = { [K in keyof T]: T[K] extends RakunSource<infer R> ? R : never }
export type ReturnUnzipWhen<T> = { [K in keyof T]: T[K] extends (value: any) => RakunSource<infer R> ? R : never }
